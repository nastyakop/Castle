...
namespace Castle
{
    public class World:IWorld
    {
        ...
        public World(double worldWidthOut, double worldHeightOut, double worldWidth, double worldHeight)
        {
        ...
        {
            return CastleFeatures.Water > 0 && CastleFeatures.Bread > 0 && CastleFeatures.Beer > 0 && CastleFeatures.Meat > 0;
        }
